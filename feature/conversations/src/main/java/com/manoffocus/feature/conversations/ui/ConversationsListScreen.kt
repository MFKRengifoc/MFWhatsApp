    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(
                        ...
                        Icon(imageVector = Icons.Rounded.Menu, contentDescription = stringResource(id = R.string.conversations_icon_menu_description ))
                    }
                }
            )
        },
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(imageVector = Icons.Default.Add, contentDescription = stringResource(id = R.string.conversations_icon_add_description))
            }
        },
